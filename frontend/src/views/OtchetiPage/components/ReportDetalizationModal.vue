...
const fieldMapping = [
  ...
  { key: 'commission_percent', label: 'Итоговый кВВ без НДС, %' },
  ...
  { key: 'ppvz_sales_commission', label: 'Вознаграждение с продаж до вычета услуг поверенного, без НДС' },
